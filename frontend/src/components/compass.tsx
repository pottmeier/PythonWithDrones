...
const Compass = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-28 lg:h-28 flex items-center justify-center">
      <div className="relative w-28 h-28 shrink-0 origin-center scale-[0.571] sm:scale-[0.714] lg:scale-100 rounded-full bg-black/20 backdrop-blur-md border border-white flex items-center justify-center pointer-events-none">
