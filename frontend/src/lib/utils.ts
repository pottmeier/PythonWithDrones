...
export const SPEED_CONTAINER = "flex bg-white/90 dark:bg-slate-800 rounded-md border border-gray-200 dark:border-slate-700 overflow-hidden h-8";
export const SPEED_BTN_BASE = "px-2 text-[10px] font-bold transition-colors border-r last:border-r-0 border-gray-200 dark:border-slate-700 hover:bg-blue-100 dark:hover:bg-blue-900/30 cursor-pointer";
