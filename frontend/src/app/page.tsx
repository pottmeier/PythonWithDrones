...
export default function Home() {
  ...
  useEffect(() => {
    const loadLevels = async () => {
      ...
      const files = ["Level_1.yaml", "Level_2.yaml", "Level_3.yaml", "Level_4.yaml", "Level_5.yaml", "Level_6.yaml", "Level_7.yaml", "Level_8.yaml", "Level_9.yaml", "Level_10.yaml", "Level_11.yaml", "Level_12.yaml", "Level_13.yaml", "Level_14.yaml", "Level_15.yaml"];
